...
>) {
  ...
  const rotateDirection = (currentDirection: Direction) => {
  ...
  const movingMap: Record<Direction, string> = {
    TOP: "radial-gradient(20% 50% at 50% 0%, #3275F8 0%, rgba(50, 117, 248, 0) 100%)",
    LEFT: "radial-gradient(16.6% 43.1% at 0% 50%, #3275F8 0%, rgba(50, 117, 248, 0) 100%)",
    BOTTOM:
      "radial-gradient(20% 50% at 50% 100%, #3275F8 0%, rgba(50, 117, 248, 0) 100%)",
    RIGHT:
      "radial-gradient(16.2% 41.199999999999996% at 100% 50%, #3275F8 0%, rgba(50, 117, 248, 0) 100%)",
  };
