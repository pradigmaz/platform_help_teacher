...
class PDFService:
    ...
    async def get_cached_pdf(self, lecture_id: UUID, updated_at_hash: str) -> bytes | None:
    ...
    async def generate_pdf(self, lecture_id: UUID, updated_at_hash: str | None = None) -> bytes:
        """
