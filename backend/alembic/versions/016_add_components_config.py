...
DEFAULT_COMPONENTS_CONFIG = {
    ...
    "tests": {"enabled": False, "weight": 0.0, "grading_scale": 10, "count": 0},
    "independent_works": {"enabled": False, "weight": 0.0, "grading_scale": 10, "count": 0},
    "colloquia": {"enabled": False, "weight": 0.0, "grading_scale": 10, "count": 0},
    "attendance": {
        "enabled": True,
        "weight": 20.0,
        "present_points": 1.0,
    ...
    "activity": {"enabled": True, "weight": 20.0, "participation_points": 0.5},
    "final_project": {"enabled": False, "weight": 0.0, "grading_scale": 10},
}
...
def upgrade() -> None:
    ...
    op.execute(f"UPDATE attestation_settings SET components_config = '{config_json}'::jsonb")
