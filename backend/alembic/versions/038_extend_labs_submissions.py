...
def upgrade() -> None:
    ...
    op.create_foreign_key("fk_labs_subject_id", "labs", "subjects", ["subject_id"], ["id"], ondelete="SET NULL")
    ...
    op.create_foreign_key("fk_labs_lesson_id", "labs", "lessons", ["lesson_id"], ["id"], ondelete="SET NULL")
