...
def upgrade() -> None:
    ...
    # === ПЕРЕИМЕНОВАНИЕ ===
    op.alter_column("attestation_settings", "soft_deadline_days", new_column_name="late_threshold_days")

    # === БАЛЛЫ ЗА ОЦЕНКИ ЛАБОРАТОРНЫХ (настраиваемые) ===
    op.add_column(
        "attestation_settings", sa.Column("grade_5_points", sa.Float(), nullable=False, server_default="10.0")
    )
    op.add_column("attestation_settings", sa.Column("grade_4_points", sa.Float(), nullable=False, server_default="7.0"))
    op.add_column("attestation_settings", sa.Column("grade_3_points", sa.Float(), nullable=False, server_default="4.0"))
    op.add_column("attestation_settings", sa.Column("grade_2_points", sa.Float(), nullable=False, server_default="0.0"))

    # === ОГРАНИЧЕНИЕ ОЦЕНКИ ПРИ ПРОСРОЧКЕ ===
    op.add_column("attestation_settings", sa.Column("late_max_grade", sa.Integer(), nullable=False, server_default="4"))
    op.add_column(
        "attestation_settings", sa.Column("very_late_max_grade", sa.Integer(), nullable=False, server_default="3")
    )

    # === САМОСТОЯТЕЛЬНЫЕ РАБОТЫ ===
    op.add_column(
        "attestation_settings", sa.Column("self_works_enabled", sa.Boolean(), nullable=False, server_default="false")
    )
    op.add_column(
        "attestation_settings", sa.Column("self_works_weight", sa.Float(), nullable=False, server_default="0.0")
    )
    op.add_column(
    ...
    op.add_column(
        "attestation_settings", sa.Column("self_works_grade_4_points", sa.Float(), nullable=False, server_default="7.0")
    )
    op.add_column(
        "attestation_settings", sa.Column("self_works_grade_3_points", sa.Float(), nullable=False, server_default="4.0")
    )
    op.add_column(
        "attestation_settings", sa.Column("self_works_grade_2_points", sa.Float(), nullable=False, server_default="0.0")
    )

    # === КОЛЛОКВИУМ ===
    op.add_column(
        "attestation_settings", sa.Column("colloquium_enabled", sa.Boolean(), nullable=False, server_default="false")
    )
    op.add_column(
        "attestation_settings", sa.Column("colloquium_weight", sa.Float(), nullable=False, server_default="0.0")
    )
    op.add_column(
        "attestation_settings",
    ...
    op.add_column(
        "attestation_settings", sa.Column("colloquium_grade_3_points", sa.Float(), nullable=False, server_default="5.0")
    )
    op.add_column(
        "attestation_settings", sa.Column("colloquium_grade_2_points", sa.Float(), nullable=False, server_default="0.0")
    )
    ...
    for col in [
        ...
        "self_works_enabled",
        "self_works_weight",
        "self_works_grade_5_points",
        "self_works_grade_4_points",
        "self_works_grade_3_points",
        "self_works_grade_2_points",
        "colloquium_enabled",
        "colloquium_weight",
        "colloquium_grade_5_points",
        "colloquium_grade_4_points",
        "colloquium_grade_3_points",
        "colloquium_grade_2_points",
    ]:
...
def downgrade() -> None:
    ...
    op.alter_column("attestation_settings", "late_threshold_days", new_column_name="soft_deadline_days")

    # === ВОССТАНОВЛЕНИЕ УДАЛЁННЫХ ПОЛЕЙ ===
    op.add_column("attestation_settings", sa.Column("excused_points", sa.Float(), nullable=False, server_default="0.0"))
    op.add_column(
        "attestation_settings", sa.Column("hard_deadline_penalty", sa.Float(), nullable=False, server_default="0.5")
    )
    op.add_column(
        "attestation_settings", sa.Column("soft_deadline_penalty", sa.Float(), nullable=False, server_default="0.7")
    )
    op.add_column(
        "attestation_settings", sa.Column("bonus_per_extra_lab", sa.Float(), nullable=False, server_default="0.4")
    )
    op.add_column("attestation_settings", sa.Column("components_config", JSONB(), nullable=True))
