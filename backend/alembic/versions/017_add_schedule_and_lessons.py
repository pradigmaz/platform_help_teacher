...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "teacher_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("users.id", ondelete="SET NULL"), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.ForeignKey("schedule_items.id", ondelete="SET NULL"),
            nullable=True,
        ),
        sa.Column(
            "group_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("groups.id", ondelete="CASCADE"), nullable=False
        ...
        sa.Column(
            "work_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("works.id", ondelete="SET NULL"), nullable=True
        ),
    ...
    if "attendance" in tables:
        ...
        op.create_foreign_key(
            "fk_attendance_lesson", "attendance", "lessons", ["lesson_id"], ["id"], ondelete="SET NULL"
        )
        ...
        op.create_unique_constraint(
            "uq_attendance_student_date_lesson", "attendance", ["student_id", "date", "lesson_number"]
        )
