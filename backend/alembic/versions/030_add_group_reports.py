...
def upgrade() -> None:
    ...
    op.create_foreign_key("fk_group_reports_group", "group_reports", "groups", ["group_id"], ["id"], ondelete="CASCADE")
    op.create_foreign_key(
        "fk_group_reports_creator", "group_reports", "users", ["created_by"], ["id"], ondelete="CASCADE"
    )
    ...
    op.create_foreign_key(
        "fk_report_views_report", "report_views", "group_reports", ["report_id"], ["id"], ondelete="CASCADE"
    )
