...
def upgrade() -> None:
    ...
    op.add_column("student_audit_log", sa.Column("actor_role", sa.String(20), nullable=False, server_default="student"))

    # Add index for filtering by role
    op.create_index("idx_student_audit_actor_role", "student_audit_log", ["actor_role"])
