...
def upgrade() -> None:
    ...
    op.add_column("lectures", sa.Column("subject_id", postgresql.UUID(as_uuid=True), nullable=True))

    # Add foreign key constraint
    op.create_foreign_key("fk_lectures_subject", "lectures", "subjects", ["subject_id"], ["id"], ondelete="SET NULL")
