...
def downgrade() -> None:
    ...
    op.add_column(
        "attestation_settings", sa.Column("late_threshold_days", sa.Integer(), nullable=False, server_default="7")
    )
    ...
    op.add_column("labs", sa.Column("deadline", sa.DateTime(timezone=True), nullable=True))
